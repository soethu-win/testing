...
<head>
	...
	<!-- Favicon-->
    <link rel="apple-touch-icon" sizes="57x57" href="{{asset('main/favicon/apple-icon-57x57.png')}}">
	<link rel="apple-touch-icon" sizes="60x60" href="{{asset('main/favicon/apple-icon-60x60.png')}}">
	<link rel="apple-touch-icon" sizes="72x72" href="{{asset('main/favicon/apple-icon-72x72.png')}}">
	<link rel="apple-touch-icon" sizes="76x76" href="{{asset('main/favicon/apple-icon-76x76.png')}}">
	<link rel="apple-touch-icon" sizes="114x114" href="{{asset('main/favicon/apple-icon-114x114.png')}}">
	<link rel="apple-touch-icon" sizes="120x120" href="{{asset('main/favicon/apple-icon-120x120.png')}}">
	<link rel="apple-touch-icon" sizes="144x144" href="{{asset('main/favicon/apple-icon-144x144.png')}}">
	<link rel="apple-touch-icon" sizes="152x152" href="{{asset('main/favicon/apple-icon-152x152.png')}}">
	<link rel="apple-touch-icon" sizes="180x180" href="{{asset('main/favicon/apple-icon-180x180.png')}}">
	<link rel="icon" type="image/png" sizes="192x192"  href="{{asset('main/favicon/android-icon-192x192.png')}}">
	<link rel="icon" type="image/png" sizes="32x32" href="{{asset('main/favicon/favicon-32x32.png')}}">
	<link rel="icon" type="image/png" sizes="96x96" href="{{asset('main/favicon/favicon-96x96.png')}}">
	<link rel="icon" type="image/png" sizes="16x16" href="{{asset('main/favicon/favicon-16x16.png')}}">

    <!-- iconfont CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('main/icon/icofont/icofont.min.css')}}">
	<!-- Boxicon CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('main/icon/boxicons-master/css/boxicons.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('main/css/media_query.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('main/css/owl.theme.default.css')}}">
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-1">
				...
				<img src="{{asset('main/logo/logo_big.jpg')}}" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none">

				<img src="{{asset('main/logo/logo_med.jpg')}}" class="img-fluid d-xl-none d-lg-none d-md-inline d-sm-none d-none" style="width: 100px">

				<img src="{{asset('main/logo/logo.jpg')}}" class="img-fluid d-xl-none d-lg-none d-md-none d-sm-inline d-inline pl-2" style="width: 30px">
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-4 col-sm-2 col-2 order-xl-2 order-lg-2 order-md-3 order-sm-3 order-3">
				<div class="row">
					...
					<div class="col-lg-4 col-10">
						<a href="{{route('registerpage')}}" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right"> | Sign-up </a>  <a href="{{route('loginpage')}}" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right"> Login</a>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<img src="{{asset('main/image/download.png')}}" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none" style="width: 150px">
			</div>
		</div>
	</div>
	<div id="myPage"></div>
	...
	<div id="mySidebar" class="sidebar">
		<div class="row">
			<div class="col-10">
	  			<img src="{{asset('ain/logo/logo_med_trans.png')}}m" class="img-fluid" style="width: 100px">
			</div>
			<div class="col-2">
		...
		<div class="mt-3">
			...
			<img src="{{asset('main/image/download.png')}}" class="img-fluid ml-2 text-center" style="width: 150px">
			<hr>

			<p class="text-white ml-3"> Copyright &copy; <img src="{{asset('main/logo/logo_wh_transparent.png')}}" style="width: 20px; height: 20px"> 2019  </p>
  	...
  	<footer class="py-3 mt-5">
    	<div class="container">
    		<div class="text-center pb-3">
      		...
      		<p class="m-0 text-center text-white">Copyright &copy; <img src="{{asset('main/logo/logo_wh_transparent.png')}}" style="width: 30px; height: 30px"> 2019</p>
    	</div>
  	</footer>
	...
	<!-- BOOTSTRAP JS -->
    <script type="text/javascript" src="{{asset('main/js/bootstrap.bundle.min.js')}}"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick.js"></script>
    <script type="text/javascript" src="{{asset('main/js/custom.js')}}"></script>
    <script type="text/javascript" src="{{asset('main/js/localstorage_custom.js')}}"></script>

    <!-- Owl Carousel -->
    <script type="text/javascript" src="{{asset('main/js/owl.carousel.js')}}"></script>
